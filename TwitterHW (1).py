...
umsi_tweets=get_tweets()['statuses']
...
for element in umsi_tweets:
    tup = element['id'],element['user']['screen_name'],element['created_at'],element['text'],element['retweet_count']
